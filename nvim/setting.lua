...
augroups{
  ...
  filetypes = {
    ...
    "Filetype * set fdm=indent",
    "Filetype rust set foldexpr=completion_treesitter#foldexpr()",
    "Filetype rust set foldmethod=expr",
    "Filetype go set foldexpr=completion_treesitter#foldexpr()",
    "Filetype go set foldmethod=expr",
    "Filetype lua set foldexpr=completion_treesitter#foldexpr()",
    "Filetype lua set foldmethod=expr",
    "Filetype cpp set foldexpr=completion_treesitter#foldexpr()",
    "Filetype cpp set foldmethod=expr",
    "Filetype c set foldexpr=completion_treesitter#foldexpr()",
    "Filetype c set foldmethod=expr",
    "Filetype json set foldexpr=completion_treesitter#foldexpr()",
