...
local function _4_(use)
  ...
  use({config = _19_, "petertriho/nvim-scrollbar"})
  ...
  use({config = _42_, ft = "markdown", module = {"peek"}, opt = true, run = "deno task --quiet build:fast", "toppair/peek.nvim"})
  local function _43_()
    return (require("colorful-winsep")).setup({symbols = {"\226\148\128", "\226\148\130", "\226\148\140", "\226\148\144", "\226\148\148", "\226\148\152"}})
  end
  return use({config = _43_, "nvim-zh/colorful-winsep.nvim"})
end
