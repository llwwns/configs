...
-- vim.api.nvim_set_keymap("n", "<c-e>", "<cmd>lua require('telescope.builtin').buffers()<cr>", { silent = true })
-- vim.api.nvim_set_keymap("n", "<c-p>", "<cmd>lua require('telescope.builtin').find_files()<cr>", { silent = true })
