...
vim.keymap.set({"n"}, "<leader>hs", _23_, {silent = true})
local function _24_()
  return (require("gitsigns")).reset_hunk()
end
vim.keymap.set({"n"}, "<leader>hr", _24_, {silent = true})
local function _25_()
  return (require("gitsigns")).stage_hunk()
end
vim.keymap.set({"v"}, "<leader>hs", _25_, {silent = true})
local function _26_()
  return (require("gitsigns")).reset_hunk()
end
vim.keymap.set({"v"}, "<leader>hr", _26_, {silent = true})
local function _27_()
...
vim.keymap.set({"n"}, "<leader>td", _34_, {silent = true})
