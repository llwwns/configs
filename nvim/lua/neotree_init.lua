...
return (require("neo-tree")).setup({close_if_last_window = false, filesystem = {follow_current_file = true, hijack_netrw_behavior = "open_default", filtered_items = {visible = false}}, window = {mappings = {y = "nop", yy = "copy_to_clipboard"}}})