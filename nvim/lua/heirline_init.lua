...
local __temp = { fg = 0, bg = 0 }
local function get_highlight(hl)
  local ok, ret = pcall(utils.get_highlight, hl)
  if not ok then
    return __temp
  end
  return ret
...
local DefaultStatusline = {
  ViMode, Space, FileNameBlock, Space, Git, Space, Diagnostics, Align, Align,
  LSPActive, Space, FileEncoding, Space, FileFormat, Space, FileType, Space, Ruler, Space, ScrollBar
}
